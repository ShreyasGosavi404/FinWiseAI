...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("Your file should include:")
        st.markdown("- `Date` (YYYY-MM-DD)\n- `Category`\n- `Amount`")
        sample_csv = "Date,Category,Amount\n2024-01-01,Housing,1200\n2024-01-02,Food,250"
        st.download_button("⬇️ Download Sample", data=sample_csv, file_name="sample_expenses.csv", mime="text/csv")
        
        # ---- HEADER ----
        st.title("💸 AI Financial Coach")
        st.caption("Personalized insights for budgeting, saving, and debt management using intelligent agents.")
...
# App description and divider
        st.info(
            "This tool analyzes your financial data and provides tailored recommendations "
            "for budgeting, savings, and debt management using multiple specialized AI agents.")
        st.divider()
 ...
 This application leverages Google's Agent Development Kit (ADK) to deliver comprehensive financial insights and personalized
 guidance using a set of specialized AI agents:

 1. 🔍 Budget Analysis Agent
    - Evaluates your spending habits
    - Highlights opportunities to cut costs
    - Offers clear, actionable advice
                    
 2. 💰 Savings Strategy Agent
    - Designs tailored savings plans
    - Estimates required emergency funds
    - Recommends automation for consistent saving

 3. 💳 Debt Reduction Agent
    - Builds smart strategies for paying off debt
    - Analyzes and compares repayment options
    - Delivers practical tips for reducing debt

 === Privacy & Security ===

 - All processing is performed locally on your device
 - No financial data is stored or transmitted
 - Secure API communication with Google services is used
        """)
